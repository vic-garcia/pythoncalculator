...
Button1 = HoverButton(frame, text= "1", borderwidth=2, height=2, width=5, font= ('Comic sens MC',12,'bold'),relief = "raised", activebackground="aqua", bg ='lightblue',  anchor="center", command=lambda: obtener(1))  
...
Button_borrar = HoverButton(frame, text= "AC", height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2, relief = "raised", activebackground="red", bg='#FD5603', anchor="center",command=lambda: borrar_todo())  
Button_borrar.grid(column =5, row=1, pady=2,padx=2)
...
Button_mas = HoverButton(frame, text= "×", height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua", bg='#2A16F7',  anchor="center",command=lambda: obtener('*'))  
...
Button_menos = HoverButton(frame, text= "+", height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua", bg='#2A16F7',  anchor="center",command=lambda: obtener('+'))  
Button_menos.grid(column =3, row=3, pady=2,padx=2)

Button0 = HoverButton(frame, text= "÷",height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua",bg ='#2A16F7',  anchor="center",command=lambda: obtener('/'))  
Button0.grid( column= 5, row=2, pady=1,padx=1)
...
Button_entre = HoverButton(frame, text= "EXP", height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua",bg ='#2A16F7',  anchor="center",command=lambda: obtener("**"))  
Button_entre.grid(column =2, row=4, pady=1,padx=1)

Button_por = HoverButton(frame, text= "(", height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua", bg='#2A16F7',  anchor="center",command=lambda: obtener('('))  
Button_por.grid(column =3, row=4, pady=2,padx=2)

Button0 = HoverButton(frame, text= ")",height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua",bg ='#2A16F7',  anchor="center",command=lambda: obtener(')'))  
Button0.grid( column= 5, row=4, pady=1,padx=1)

#fila 5

Button_igual = HoverButton(frame, text= "=", height=2, width=12,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="#FD5603", bg='#2FEC71', anchor="center",command=lambda: operacion())  
Button_igual.grid(column =1 ,columnspan=2, row=5, pady=1,padx=1)

Button0 = HoverButton(frame, text= "-",height=2, width=5,font= ('Comic sens MC',12,'bold'), borderwidth=2,  relief = "raised", activebackground="aqua",bg ='#2A16F7',  anchor="center",command=lambda: obtener('-'))  
Button0.grid( column= 5, row=3, pady=1,padx=1)
